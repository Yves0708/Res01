package net.cloud95.android.lession.res01;
...
public class Res01Activity extends Activity {
    ...
    public void clickButton01(View view) {
        ...
        AlertDialog.Builder d = new AlertDialog.Builder(
                Res01Activity.this, AlertDialog.THEME_HOLO_LIGHT);
        // 設定標題為文字資源
            ...
            new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (!(usernameValue.equals(simonUsername) && 
                        ...
                        // 讀取顏色資源
                        int color = r.getColor(R.color.failure_text_color);
                        ...
                        // 讀取顏色資源
                        int color = r.getColor(R.color.buttons_text_color);
                        button06.setTextColor(color);
